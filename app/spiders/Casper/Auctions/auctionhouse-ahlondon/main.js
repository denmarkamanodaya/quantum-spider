...
function parse(lotData) 
{
	...
	// Images
        ...
        // Price
	//lot["price"] = document.querySelector("#input-maximum-bid").innerText.trim();
	//lot["estimate"] = document.querySelector("#input-maximum-bid").innerText.trim();
	
	// Address
	//var lot_address = document.querySelectorAll("div.topbar-lot-info > div.container > div.row");	
	//lot["address"] = lot_address.children[1].innerText.trim();
