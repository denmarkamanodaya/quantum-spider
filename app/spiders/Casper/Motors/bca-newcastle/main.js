...
var getFacetURL = "https://auctionview.british-car-auctions.co.uk/buyer/facetedSearch/GetActiveFacetValues?q=&vehicleType=*&currentFacet=salelocation_exact&cultureCode=en";
...
var locationX = "newcastle-u-tyne";
...
function getLocations() {
    ...
    this.thenOpen(getFacetURL, { method: "post" })
		...
		{
			qs.log(loc.Description.toLowerCase());
		}
                })[0];
