...
casper
    ...
    .then(function() {
        ...
        */
        test = gatherAllAuctionPages.call(this);
	qs.log("GERGER"+test);
        /*
...
function gatherAllAuctionPages() {
    this.then(function() {
		...
		.querySelector('[class*="pagination_number hide_mobile"]')
                .innerText.trim();
	...
	/*
            for (var i = 1; i <= total; i++) {
                pages.push(
                    "https://auctions.asm-autos.co.uk/vehicle-list/?type=9&make=&trns=0&fuel=0&catc=0&memr=32&site=&dist=0&sort=0&srch=&page=" +
                        i
                );
            }
